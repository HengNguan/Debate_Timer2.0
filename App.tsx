        ...
        {currentTab === 'TIMER' ? (
          <div className="flex-1 flex flex-col">
            ...
            {isFlowMode && rounds.length > 0 ? (
              <div className="bg-slate-900 border-b border-slate-800 p-3 flex items-center justify-between px-6 shadow-md">
                <button 
                  onClick={prevRound} 
                ...
                <div className="text-center">
                   ...
                   <div className="text-white font-bold flex items-center gap-2 justify-center">
                     {currentRound.title}
                   </div>
                </div>
